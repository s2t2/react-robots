    ...
    return (
      <div className="form-group">
        ...
        <div className="col-sm-10">
          <input id="robot-name" type="text" className="form-control" name="robotName" ref="robotNameRef" placeholder="My Robot" value={this.props.bot.name} onInput={this.changeName}/>
        </div>
      </div>
    )
  },
